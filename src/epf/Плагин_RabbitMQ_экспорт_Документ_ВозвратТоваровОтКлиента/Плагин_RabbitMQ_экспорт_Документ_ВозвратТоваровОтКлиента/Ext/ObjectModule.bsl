...
Функция ВыгрузитьОбъект(Ссылка) Экспорт
	...
	definition.Вставить("ДатаВходящегоДокумента", Обк.ДатаВходящегоДокумента);
	definition.Вставить("ДатаВыдачиДокументаПокупателя", Обк.ДатаВыдачиДокументаПокупателя);
	definition.Вставить("ДатаПоступления", Обк.ДатаПоступления);
	definition.Вставить("ДатаРасходногоКассовогоОрдера", Обк.ДатаРасходногоКассовогоОрдера);
	definition.Вставить("ДатаРожденияПокупателя", Обк.ДатаРожденияПокупателя);
