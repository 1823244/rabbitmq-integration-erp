...
Функция ЗагрузитьОбъект(СтруктураОбъекта) Экспорт
	...
	Попытка
		...
		ОбъектДанныхПартнер.ОбменДанными.Загрузка = Ложь;// было Истина, но лучше пусть отрабатывают события - в них пишется служебная информация
		
		ОбъектДанныхПартнер.Записать(); 
		
		ОбъектДанных.Партнер = ОбъектДанныхПартнер.Ссылка;
		
		ОбъектДанных.ОбменДанными.Загрузка = Истина;// было Истина, но лучше пусть отрабатывают события - в них пишется служебная информация
