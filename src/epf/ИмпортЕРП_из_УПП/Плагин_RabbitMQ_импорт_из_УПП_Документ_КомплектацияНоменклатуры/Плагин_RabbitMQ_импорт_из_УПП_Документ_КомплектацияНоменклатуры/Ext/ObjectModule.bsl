...
Функция Найти_в_спр_КСП_ВидыОперацийПоСкладамУПП_Получатели(СкладУПП, СкладХраненияУПП)
	...
	Если ЗначениеЗаполнено(СкладХраненияУПП) и СкладХраненияУПП <> Справочники.ксп_СкладыХраненияУПП.ПустаяСсылка() Тогда
		Запрос.Текст = Запрос.Текст + " И ТЧ.СкладХраненияУПП = &СкладХраненияУПП";
