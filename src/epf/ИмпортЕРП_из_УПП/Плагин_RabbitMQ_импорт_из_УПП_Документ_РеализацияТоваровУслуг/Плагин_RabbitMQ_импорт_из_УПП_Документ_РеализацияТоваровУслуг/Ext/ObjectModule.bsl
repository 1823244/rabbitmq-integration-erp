...
Функция ЗагрузитьОбъект(СтруктураОбъекта, пjsonText = "") Экспорт
	...
	Если ВидОперации = "ПродажаКомиссия"
...
Функция СоздатьЗаказНаПеремещение(СтруктураОбъекта, СуществующийЗаказСсылка)
	...
	ОбъектДанных.СкладОтправитель = ксп_ИмпортСлужебный.НайтиСклад(деф.Склад, мВнешняяСистема);
...
Функция Тест_Схема_1_ПеремещениеНаФулфилмент(Json) Экспорт
