...
Функция ЗагрузитьОбъект(СтруктураОбъекта, jsonText = "") Экспорт
    ...
    Попытка
		...
		Если (Лев(деф.Комментарий,15) = "остатки для ERP" и деф.DeletionMark)
			или (Лев(деф.Комментарий,23) = "остатки розницы для ERP" и деф.DeletionMark)Тогда
		...
		ВидДокСубПлагин = "ЗаказНаВнутреннееПотребление";
