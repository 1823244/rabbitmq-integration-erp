...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Версия","1.35");
...
Процедура ЗаполнитьДокументВводОстатковТоваров(ОбъектДанных, деф, id)
	...
	Попытка
		...
		ОбъектДанных.Записать();
	Исключение
	    мЛоггер.ерр("Ошибка заполнения АналитикаУчетаНоменклатуры. Документ все равно загружен. Номер: %1", ОбъектДанных.Номер);
	КонецПопытки;
