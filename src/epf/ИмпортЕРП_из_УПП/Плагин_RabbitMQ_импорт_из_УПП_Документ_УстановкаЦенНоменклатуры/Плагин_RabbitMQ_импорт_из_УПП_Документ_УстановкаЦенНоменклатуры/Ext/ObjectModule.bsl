...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ДобавитьКоманду(ПараметрыРегистрации.Команды, 
		...
		"Форма_Плагин_RabbitMQ_импорт_из_УПП_Документ_УстановкаЦенНоменклатуры",
		ТипКоманды, 
		Ложь) ;
...
Функция ЗагрузитьОбъект(СтруктураОбъекта, jsonText = "") Экспорт
	...
	ПредставлениеДокументаУПП 			= "УстановкаЦенНоменклатуры №"+деф.Number+" от "+строка(деф.Date);
	
	Обработчик = Справочники.ДополнительныеОтчетыИОбработки.НайтиПоНаименованию("СубПлагин_импорт_УстановкаЦенНоменклатуры", Истина);
	Если НЕ ЗначениеЗаполнено(Обработчик) Тогда
		...
		ТекстСообщения 		= "Не найден суплагин импорта!";
