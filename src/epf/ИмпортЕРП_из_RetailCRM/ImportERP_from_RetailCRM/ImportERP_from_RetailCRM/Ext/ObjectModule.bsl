...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование","Импорт из RetailCRM");
	ПараметрыРегистрации.Вставить("БезопасныйРежим", Ложь);
	ПараметрыРегистрации.Вставить("Информация","Импорт из RetailCRM");
	...
	ДобавитьКоманду(ПараметрыРегистрации.Команды, "Открыть форму : Импорт из RetailCRM","ЗагрузитьДанныеИзRetailCRMИнтерактивно",ТипКоманды, Ложь) ;
	
	ТипКоманды = ДополнительныеОтчетыИОбработкиКлиентСервер.ТипКомандыВызовСерверногоМетода();
	ДобавитьКоманду(ПараметрыРегистрации.Команды, "Выполнить импорт из RetailCRM","ЗагрузитьДанныеИзRetailCRM",ТипКоманды, Ложь) ;
...
Процедура ВыполнитьКоманду(ИмяКоманды, ПараметрыВыполнения) Экспорт
	...
	Если ИмяКоманды = "ЗагрузитьДанныеИзRetailCRM" Тогда
		ВыполнитьИмпорт();
	КонецЕсли;
...
Процедура ВыполнитьИмпорт() Экспорт
	...
	ЗагрузитьДанныеИзОчереди("to-erp-from-retail-static");
	ЗагрузитьДанныеИзОчереди("to-erp-from-retail-doc");
		
КонецПроцедуры

&НаСервере
Процедура ИмпортНоменклатуры() Экспорт
...
ИмяСобытияЖР = "Импорт_из_RetailCRM";
