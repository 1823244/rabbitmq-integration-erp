...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Информация","ОтложенноеПроведение_ОчисткаРегистра");
...
Функция ВыполнитьОчистку() Экспорт
	...
	СтатусыОбъектов.Добавить(Перечисления.ПеречислениеСсылка.ксп_СтатусыКачестваДокументов.ОК);
