...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование","Импорт из 1С:Розница");
	ПараметрыРегистрации.Вставить("БезопасныйРежим", Ложь);
	ПараметрыРегистрации.Вставить("Информация","Импорт из 1С:Розница");
	...
	ДобавитьКоманду(ПараметрыРегистрации.Команды, "Импорт из 1С:Розница","ЗагрузитьДанныеИз1СРозница",ТипКоманды, Ложь) ;
...
Процедура ВыполнитьКоманду(ИмяКоманды, ПараметрыВыполнения) Экспорт
	...
	Если ИмяКоманды = "ЗагрузитьДанныеИз1СРозница" Тогда
		ВыполнитьИмпорт();
	КонецЕсли;
...
Процедура ВыполнитьИмпорт() Экспорт
	...
	ЗагрузитьДанныеИз1СРозница_НСИ();
	ЗагрузитьДанныеИз1СРозница_Документы();

КонецПроцедуры



Процедура ЗагрузитьДанныеИз1СРозница_НСИ()
...
Процедура ЗагрузитьДанныеИз1СРозница_Документы()
...
Процедура ВыполнитьИмпорт_НСИ() Экспорт
	...
	ИмяОчереди	 			= "to-erp-from-retail-static";
...
Процедура ВыполнитьИмпорт_Документы() Экспорт
	...
	ИмяОчереди	 			= "to-erp-from-retail-doc";
