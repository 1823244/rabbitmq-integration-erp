...
//	НаборЗаписей_ТЧОплатаПлатежнымиКартами = РегистрыСведений.ЧекККМ_ТЧ_ОплатаПлатежнымиКартами__.СоздатьНаборЗаписей();
//	НаборЗаписей_ТЧОплатаПлатежнымиКартами.Отбор.ГУИД.установить(id.Ref);
//	НаборЗаписей_ТЧОплатаПлатежнымиКартами.Отбор.ВнешняяСистема.установить(мВнешняяСистема);


//	счНомерСтроки = 0;

//	Для сч = 0 По деф.ТЧОплатаПлатежнымиКартами.Количество()-1 Цикл

//		стрк = деф.ТЧОплатаПлатежнымиКартами[сч];

//		СтрокаТЧ = НаборЗаписей_ТЧОплатаПлатежнымиКартами.Добавить();
...
//		Если ЕстьАтрибут Тогда
//			СтрокаТЧ.ЭквайринговыйТерминал = стрк.ЭквайринговыйТерминал.Ref;
//		Иначе
...
//	НаборЗаписей_ТЧОплатаПлатежнымиКартами.Записать();
//	//------------------------------------------------------     ТЧ СкидкиНаценки
