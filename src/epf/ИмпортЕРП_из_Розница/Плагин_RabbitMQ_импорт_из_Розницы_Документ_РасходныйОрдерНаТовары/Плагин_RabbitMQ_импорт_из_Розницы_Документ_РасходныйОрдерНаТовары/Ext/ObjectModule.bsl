...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование","Плагин_RabbitMQ_импорт_из_Розницы_Документ_РасходныйОрдерНаТовары");
	ПараметрыРегистрации.Вставить("БезопасныйРежим", Ложь);
	ПараметрыРегистрации.Вставить("Информация","Плагин_RabbitMQ_импорт_из_Розницы_Документ_РасходныйОрдерНаТовары");
	...
	ДобавитьКоманду(ПараметрыРегистрации.Команды, 
		"Открыть форму : Плагин_RabbitMQ_импорт_из_Розницы_Документ_РасходныйОрдерНаТовары",
...
//РеализацияТоваров
		...
		Если ЕстьАтрибут Тогда
			...
			Если деф.ДокументОснование.свойство("type",type) Тогда
				Если type = "Документ.ПеремещениеТоваров" Тогда
