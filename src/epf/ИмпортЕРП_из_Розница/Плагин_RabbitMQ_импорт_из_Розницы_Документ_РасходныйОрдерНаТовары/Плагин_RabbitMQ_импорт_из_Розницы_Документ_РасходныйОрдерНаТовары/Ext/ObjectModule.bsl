...
Функция ЗагрузитьОбъект(СтруктураОбъекта, jsonText = "") Экспорт
	...
	//Для счТовары = 0 По деф.ТЧТоварыПоРаспоряжениям.Количество()-1 Цикл
	//	стрк = деф.ТЧТоварыПоРаспоряжениям[счТовары];
	...
	//	КонецЕсли;
	//	// на случай, если есть метод поиска ссылки:
	//	СтрокаТЧ.Распоряжение = ксп_ИмпортСлужебный.НайтиРаспоряжение(стрк.Распоряжение);
