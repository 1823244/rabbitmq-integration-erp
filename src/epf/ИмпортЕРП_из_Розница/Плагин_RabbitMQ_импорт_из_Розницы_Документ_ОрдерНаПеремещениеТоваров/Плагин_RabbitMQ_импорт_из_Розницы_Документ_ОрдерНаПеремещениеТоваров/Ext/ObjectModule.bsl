...
Функция ЗагрузитьОбъект(СтруктураОбъекта, jsonText = "") Экспорт
	...
	Попытка			
		...
		СоздатьПриходныйОрдерНаТовары(ЗаказНаПеремещение);
...
//	Тип: Тип_значения
//
Функция СоздатьПриходныйОрдерНаТовары(ЗаказНаПеремещение) Экспорт
	
	ИскомыйДокумент = НайтиПодчиненныйПриходныйОрдер(ЗаказНаПеремещение);
...
//	Тип: Тип_значения
//
Функция НайтиПодчиненныйПриходныйОрдер(ЗаказНаПеремещение)
	...
	Запрос.Текст = 
		...
		|ГДЕ
		|	ПриходныйОрдерНаТовары.Распоряжение = &ЗаказНаПеремещение";
...
Функция ЗаполнитьРеквизиты_ПриходныйОрдер(ОбъектДанных, ЗаказНаПеремещение) Экспорт
	...
	ОбъектДанных.Распоряжение = ЗаказНаПеремещение;
	...
	ОбъектДанных.Товары.Очистить();
	Для каждого стрк Из ЗаказНаПеремещение Цикл
