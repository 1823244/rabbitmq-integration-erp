...
Функция ЗагрузитьОбъект(СтруктураОбъекта, jsonText = "") Экспорт
	...
	СуществующийОбъект = Документы.ВозвратТоваровОтКлиента.ПолучитьСсылку(Новый УникальныйИдентификатор(id.Ref));
	...
	Иначе 
		...
		СсылкаНового = Документы.ВозвратТоваровОтКлиента.ПолучитьСсылку(Новый УникальныйИдентификатор(id.Ref));
	...
	//КонецЕсли;
	//// на случай, если есть метод поиска ссылки:
	ОбъектДанных.ОбъектРасчетов = ксп_ИмпортСлужебный.НайтиСоздатьОбъектРасчетовСКлиентом(ОбъектДанных.Ссылка, ОбъектДанных.Организация);
	...
	//	СтрокаТЧ.ХарактеристикаОприходование = ксп_ИмпортСлужебный.НайтиХарактеристикаОприходование(стрк.ХарактеристикаОприходование);
		...
		СтрокаТЧ.АналитикаУчетаНоменклатуры = ксп_ИмпортСлужебный.НайтиСоздатьКлючАналитикиНом(стрк.Номенклатура, ОбъектДанных.Склад);
