...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование","Плагин_RabbitMQ_экспорт_Справочник_КартыЛояльности");
	ПараметрыРегистрации.Вставить("БезопасныйРежим", Ложь);
	ПараметрыРегистрации.Вставить("Информация","Плагин_RabbitMQ_экспорт_Справочник_КартыЛояльности");
	...
	ДобавитьКоманду(ПараметрыРегистрации.Команды, 
		"Открыть форму : Плагин_RabbitMQ_экспорт_Справочник_КартыЛояльности",
		"Форма_Плагин_RabbitMQ_экспорт_Справочник_КартыЛояльности",
		ТипКоманды, 
		Ложь) ;
...
Функция ВыгрузитьОбъект(ДанныеСсылка) Экспорт
	Если ТипЗнч(ДанныеСсылка) = Тип("СправочникСсылка.КартыЛояльности") Тогда
	...
	definition.Вставить("МагнитныйКод", Обк.МагнитныйКод);
	...
	definition.Вставить("Штрихкод", Обк.Штрихкод);
