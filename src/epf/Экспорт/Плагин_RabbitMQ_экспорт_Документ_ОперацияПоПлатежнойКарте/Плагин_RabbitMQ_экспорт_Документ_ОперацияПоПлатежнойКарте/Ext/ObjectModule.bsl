...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование","Плагин_RabbitMQ_экспорт_Документ_ОперацияПоПлатежнойКарте");
	ПараметрыРегистрации.Вставить("БезопасныйРежим", Ложь);
	ПараметрыРегистрации.Вставить("Информация","Плагин_RabbitMQ_экспорт_Документ_ОперацияПоПлатежнойКарте");
	...
	ДобавитьКоманду(ПараметрыРегистрации.Команды, 
		"Открыть форму : Плагин_RabbitMQ_экспорт_Документ_ОперацияПоПлатежнойКарте",
		"Форма_Плагин_RabbitMQ_экспорт_Документ_ОперацияПоПлатежнойКарте",
		ТипКоманды, 
		Ложь) ;
...
Функция ВыгрузитьОбъект(Ссылка) Экспорт
	...
	definition.Вставить("КодАвторизации", Обк.КодАвторизации);
	...
	definition.Вставить("ОтражатьКомиссию", Обк.ОтражатьКомиссию);
	...
	definition.Вставить("РазрешеныПлатежиБезУказанияЗаявок", Обк.РазрешеныПлатежиБезУказанияЗаявок);
	...
	definition.Вставить("УдалитьЭквайер", ксп_ЭкспортСлужебный.СоздатьУзелIdentification(Обк.УдалитьЭквайер));
