...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ДобавитьКоманду(ПараметрыРегистрации.Команды, 
		...
		"Форма_Плагин_Плагин_RabbitMQ_экспорт_Справочник_КассыККМ",
		ТипКоманды, 
		Ложь) ;
...
Функция ВыгрузитьОбъект(ДанныеСсылка) Экспорт
	...
	definition.Вставить("ГруппаФинансовогоУчетаДенежныхСредств", ксп_ЭкспортСлужебный.СоздатьУзелIdentification(Обк.ГруппаФинансовогоУчетаДенежныхСредств));
