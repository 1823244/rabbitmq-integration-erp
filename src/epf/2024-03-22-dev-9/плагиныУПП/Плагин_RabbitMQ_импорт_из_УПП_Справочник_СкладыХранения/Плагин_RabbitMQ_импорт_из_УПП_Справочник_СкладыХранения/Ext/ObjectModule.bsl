...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование","Плагин_RabbitMQ_импорт_из_УПП_Справочник_СкладыХранения");
	ПараметрыРегистрации.Вставить("БезопасныйРежим", Ложь);
	ПараметрыРегистрации.Вставить("Информация","Плагин_RabbitMQ_импорт_из_УПП_Справочник_СкладыХранения");
	...
	ДобавитьКоманду(ПараметрыРегистрации.Команды, 
		"Открыть форму : Плагин_RabbitMQ_импорт_из_УПП_Справочник_СкладыХранения",
		"Форма_Плагин_RabbitMQ_импорт_из_УПП_Справочник_СкладыХранения",
		ТипКоманды, 
		Ложь) ;
...
Функция ЗагрузитьОбъект(СтруктураОбъекта, jsonText = "") Экспорт
	...
	//Если НЕ НРег(СтруктураОбъекта.type) = НРег("справочник.СкладыХранения") Тогда
	...
	Если типзнч(СтруктураОбъекта) = тип("Массив") Тогда
		...
		Для каждого эл Из СтруктураОбъекта Цикл
			  Загрузить_Справочник_КСП_СкладыУПП(эл);
		КонецЦикла;
...
Функция Загрузить_Справочник_КСП_СкладыУПП(СтруктураОбъекта, jsonText = "") Экспорт
    ...
    ВидОбъекта 			= "ксп_СкладыХраненияУПП";
...
Функция ЗаполнитьРеквизитыЭлемента_СкладыУПП(ОбъектДанных, СтруктураОбъекта, jsonText = "") Экспорт
	...
	ОбъектДанных.Наименование = деф.code;
