...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование","Плагин_RabbitMQ_импорт_из_УПП_Справочник_ВозрастнаяГруппа");
	ПараметрыРегистрации.Вставить("БезопасныйРежим", Ложь);
	ПараметрыРегистрации.Вставить("Информация","Плагин_RabbitMQ_импорт_из_УПП_Справочник_ВозрастнаяГруппа");
	...
	ДобавитьКоманду(ПараметрыРегистрации.Команды, 
		"Открыть форму : Плагин_RabbitMQ_импорт_из_УПП_Справочник_ВозрастнаяГруппа",
		"Форма_Плагин_RabbitMQ_импорт_из_УПП_Справочник_ВозрастнаяГруппа",
		ТипКоманды, 
		Ложь) ;
...
Функция ЗагрузитьОбъект(СтруктураОбъекта, jsonText = "") Экспорт
	...
	Если НЕ НРег(СтруктураОбъекта.type) = НРег("справочник.ВозрастнаяГруппа") Тогда  
    ...
    ВидОбъекта = "КСП_ВозрастнаяГруппа";  
	...
	ЭтоНовый = Ложь;
	Если ТипЗнч(ДанныеСсылка) = ТИп("СправочникСсылка.КСП_ВозрастнаяГруппа") И НЕ ЗначениеЗаполнено(ДанныеСсылка.ВерсияДанных) Тогда 
	...
	Попытка			    
		...
		ОбъектДанных.ОтВозраста = деф.ОтВозраста;
		ОбъектДанных.ДоВозраста = деф.ДоВозраста;
