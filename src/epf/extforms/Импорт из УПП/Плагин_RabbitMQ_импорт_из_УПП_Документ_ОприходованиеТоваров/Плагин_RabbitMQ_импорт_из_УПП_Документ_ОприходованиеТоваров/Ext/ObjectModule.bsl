...
Функция ЗагрузитьОбъект(СтруктураОбъекта, jsonText = "") Экспорт
	...
	мЛоггер = КСП_ЛоггерСервер.getLogger(мИдВызова, "Импорт документов из УПП: Оприходование товаров");
	...
	Исключение
		...
		ТекстСообщения = "Плагин: Плагин_RabbitMQ_импорт_из_УПП_Документ_ОприходованиеТоваров . Подробности: " + ОписаниеОшибки();
		мЛоггер.ерр(ТекстСообщения);
