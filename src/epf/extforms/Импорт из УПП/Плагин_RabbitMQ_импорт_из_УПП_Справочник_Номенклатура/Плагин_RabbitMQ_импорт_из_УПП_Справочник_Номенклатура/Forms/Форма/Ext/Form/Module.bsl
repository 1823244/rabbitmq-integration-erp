...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	идВызова = КСП_логгерСервер.СоздатьИдВызова(Неопределено, "Импорт номенклатуры из файлов интерактивно",
	ТекущаяДата(),
...
//	Файл (File)
	...
	// переходим к отправке новой порции файлов на сервер
...
Процедура ЗагрузитьИзJsonНаСервереИзКаталога(МассивАдресов)
	...
	_идВызова = КСП_ЛоггерСервер.СоздатьИдВызова(ИдВызова, "Импорт номенклатуры. Интерактивный", ТекущаяДатаСеанса(),"Плагин", , Неопределено);
	...
	обк.ЗагрузитьИзJsonНаСервереИзМассиваАдресов(МассивАдресов, ВидНоменклатуры, Обновлять, ВариантРаботы);
...
Процедура ЗагрузитьИзJsonНаСервере()
	...
	Ссылка = РеквизитФормыВЗначение("Объект").ЗагрузитьИзJsonНаСервере(ИдВызова, JsonText, ВидНоменклатуры, ВариантРаботы);
...
Процедура ПоказатьЛог(Команда)
	КСП_логгерКлиент.ОткрытьОтчетПоЛогу(ИдВызова, Ложь, ЭтотОбъект);
КонецПроцедуры
