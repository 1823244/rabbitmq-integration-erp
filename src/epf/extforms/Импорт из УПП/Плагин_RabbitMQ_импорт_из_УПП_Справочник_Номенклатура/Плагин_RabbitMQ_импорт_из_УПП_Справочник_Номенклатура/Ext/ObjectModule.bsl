...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Версия","1.32.Поток");
...
Функция ПолучитьВидНоменклатуры2(деф)     
	
	Перем ВидНоменклатуры;
	
	//ГруппаДействующие = "83803fc7-d1f5-47a9-ba86-3233e22f4644";
	//
	//Если деф.Свойство("Parent") и деф.Parent.Свойство("Ref") и НРЕГ(деф.Parent.Ref) =  ГруппаДействующие Тогда
	//	
	...
	//Иначе 
	//    КодТНВЭД = "";
	//	Если деф.Свойство("ТНВЭД") И деф.ТНВЭД.Свойство("description", КодТНВЭД) Тогда
	//		
	//		
	// 		
	//		Если ЭтоМаркируемаяПродукция(КодТНВЭД) Тогда
	//			
	//			
	//			
	//			
