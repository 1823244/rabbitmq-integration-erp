...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование","Плагин_RabbitMQ_импорт_из_УПП_Документ_ВозвратТоваровОтПокупателя");
	ПараметрыРегистрации.Вставить("БезопасныйРежим", Ложь);
	ПараметрыРегистрации.Вставить("Информация","Плагин_RabbitMQ_импорт_из_УПП_Документ_ВозвратТоваровОтПокупателя");
	ПараметрыРегистрации.Вставить("ВерсияБСП", "3.1.5.180");
	
	ТипКоманды = ДополнительныеОтчетыИОбработкиКлиентСервер.ТипКомандыОткрытиеФормы();
	ДобавитьКоманду(ПараметрыРегистрации.Команды, 
	"Открыть форму : Плагин_RabbitMQ_импорт_из_УПП_Документ_ВозвратТоваровОтПокупателя",
	"Форма_Плагин_RabbitMQ_импорт_из_УПП_Документ_ВозвратТоваровОтПокупателя",
	ТипКоманды, 
	Ложь) ;
...
Функция ЗагрузитьОбъект(СтруктураОбъекта, jsonText = "") Экспорт
	...
	мЛоггер = мис_ЛоггерСервер.getLogger(мИдВызова, "Плагин_RabbitMQ_импорт_из_УПП_Документ_ВозвратТоваровОтПокупателя");
	...
	Попытка
		...
		ПредставлениеДокументаУПП 			= "ВозвратТоваровОтПокупателя №"+деф.Number+" от "+строка(деф.Date);
	...
	Исключение
		...
		ТекстСообщения = "Плагин: ВозвратТоваровОтПокупателя . Подробности: " + ОписаниеОшибки();
		мЛоггер.ерр(ТекстСообщения);
