...
Функция СведенияОВнешнейОбработке() Экспорт
    ...
    ПараметрыРегистрации.Вставить("Наименование","Заказ на перемещение на основании ввода остатков товара");
    ...
    ДобавитьКоманду(Команды, "Заказ на перемещение (КСП)",
            "СоздатьЗаказНаПеремещение","ВызовКлиентскогоМетода",Ложь,) ;
