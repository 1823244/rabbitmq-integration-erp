...
Функция ЗаполнитьРеквизиты(ОбъектДанных, СтруктураОбъекта, jsonText = "") Экспорт
	...
	ОбъектДанных.КратностьКурсаКонвертации = Деф.Кратность;
	ОбъектДанных.КурсКонвертации = деф.Курс;
...
//------------------------------------------------------     ТЧ РасшифровкаПлатежа
	...
	Для каждого Стрк из Деф.ТЧРасшифровкаПлатежа Цикл
		...
		СтрокаТЧ.СтатьяДвиженияДенежныхСредств = ОбъектДанных.СтатьяДвиженияДенежныхСредств;

		СтрокаТЧ.Сумма = стрк.СуммаПлатежа;

		СтрокаТЧ.СуммаВзаиморасчетов = стрк.СуммаПлатежа;
...
КонецФункции
 ...
 Функция сетИдВызова(пИдВызова) Экспорт
    ...
    мИдВызова = пИдВызова;
	мЛоггер = мис_ЛоггерСервер.getLogger(мИдВызова, "Импорт документов из Розница: Поступление в кассу");
    Возврат ЭтотОбъект;
