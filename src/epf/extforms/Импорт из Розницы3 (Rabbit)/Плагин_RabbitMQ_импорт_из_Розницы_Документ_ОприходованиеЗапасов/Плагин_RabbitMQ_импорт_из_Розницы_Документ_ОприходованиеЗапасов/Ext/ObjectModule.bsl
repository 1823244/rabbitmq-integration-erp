...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование","Плагин_RabbitMQ_импорт_из_Розницы_Документ_ОприходованиеЗапасов");
	ПараметрыРегистрации.Вставить("БезопасныйРежим", Ложь);
	ПараметрыРегистрации.Вставить("Информация","Плагин_RabbitMQ_импорт_из_Розницы_Документ_ОприходованиеЗапасов");
...
Функция ЗагрузитьОбъект(СтруктураОбъекта, jsonText = "") Экспорт
	...
	Если НЕ НРег(СтруктураОбъекта.type) = НРег("документ.оприходованиеЗапасов") Тогда
    ...
    ВидОбъекта = "ОприходованиеИзлишковТоваров";
...
КонецФункции
 ...
 Функция сетИдВызова(пИдВызова) Экспорт
    ...
    мИдВызова = пИдВызова;
	мЛоггер = мис_ЛоггерСервер.getLogger(мИдВызова, "Импорт документов из Розница: Оприходование товаров");
    Возврат ЭтотОбъект;
