...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Версия","2.16");
...
Функция СоздатьОбновитьДокументОприходованиеИзлишковТоваров(СтруктураОбъекта, СкладЕРП)
	...
	Попытка
		...
		Для счТовары = 0 По деф.ТЧТовары.Количество()-1 Цикл
			...
			Попытка
				ЭтоПодарочныйСертификат = Вычислить("РегистрыСведений.КСП_ПодарочныеСертификатыДляОприходованияУПП.ЕстьЗапись(_Номенклатура)");
			Исключение
