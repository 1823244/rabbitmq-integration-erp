...
Функция ЗагрузитьОбъект(СтруктураОбъекта, jsonText = "") Экспорт
	...
	мИдВызова = КСП_ЛоггерСервер.СоздатьИдВызова(мИдВызова, "Импорт одного документа ВзаимозачетЗадолженности "+ref, ТекущаяДатаСеанса(),
		"", Неопределено, Неопределено);
	
	мЛоггер = КСП_ЛоггерСервер.getLogger(мИдВызова, "Импорт документов из УТ: ВзаимозачетЗадолженности");
