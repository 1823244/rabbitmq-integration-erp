...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование","Плагин_RabbitMQ_импорт_из_УТ_Документ_ВозвратТоваровОтПокупателя");
	ПараметрыРегистрации.Вставить("БезопасныйРежим", Ложь);
	ПараметрыРегистрации.Вставить("Информация","Плагин_RabbitMQ_импорт_из_УТ_Документ_ВозвратТоваровОтПокупателя");
	...
	ДобавитьКоманду(ПараметрыРегистрации.Команды, 
		"Открыть форму : Плагин_RabbitMQ_импорт_из_УТ_Документ_ВозвратТоваровОтПокупателя",
		"Форма_Плагин_RabbitMQ_импорт_из_УТ_Документ_ВозвратТоваровОтПокупателя",
		ТипКоманды, 
		Ложь) ;
