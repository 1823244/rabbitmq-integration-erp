...
Функция ЗагрузитьОбъект(СтруктураОбъекта, jsonText = "", СкладЕРП = Неопределено ) Экспорт
    ...
    Попытка
		...
		мЛоггер.ерр("Субплагин Комплектация номенклатуры - Запуск");
		...
		мЛоггер.ерр("Субплагин Комплектация номенклатуры - Завершение");

		Возврат Рез;
           
    Исключение
        мЛоггер.ерр("Субплагин Комплектация номенклатуры - Ошибка. Подробности: "+ОписаниеОшибки());
	КонецПопытки;
