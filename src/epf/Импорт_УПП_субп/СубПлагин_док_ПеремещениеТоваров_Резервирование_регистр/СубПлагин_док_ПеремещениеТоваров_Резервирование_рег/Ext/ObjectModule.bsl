...
Функция СоздатьДокументыПоСхемеРезервирования_Опт(СтруктураОбъекта)
	...
	Попытка			
		ЗаказНаВнутреннееПотребление = СоздатьЗаказНаВутреннееПотребление(СтруктураОбъекта, ОбъектДанных);
	...
	Возврат ЗаказНаВнутреннееПотребление.Ссылка;
...
//	Тип: Тип_значения
//
Функция СоздатьЗаказНаВутреннееПотребление(СтруктураОбъекта, ОбъектДанных)
