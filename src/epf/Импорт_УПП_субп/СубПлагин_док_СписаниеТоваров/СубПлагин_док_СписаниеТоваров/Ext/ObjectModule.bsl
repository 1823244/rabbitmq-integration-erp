...
Функция СоздатьДокументыПоСхеме(СтруктураОбъекта, СкладЕРП)
	...
	Рез = Новый Структура;
	Рез.Вставить("Списание", Неопределено);
	...
	СуществующийДокумент 		= СоздатьПолучитьСсылкуДокумента(id.Ref, "ОрдерНаОтражениеНедостачТоваров");
	...
	Попытка	
		...
		ДокументОбъект = СоздатьСписание(СтруктураОбъекта, СуществующийДокумент, СкладЕРП);
			
		ЗафиксироватьТранзакцию();          		
		
		Рез.Вставить("Списание", ДокументОбъект.Ссылка);
...
//	Тип: Тип_значения
//
Функция СоздатьСписание(СтруктураОбъекта, СуществующийДокументСсылка, СкладЕРП)
