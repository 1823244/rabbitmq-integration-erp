...
Функция ЗагрузитьОбъект(СтруктураОбъекта, jsonText = "") Экспорт
	...
	Если Лев(деф.Комментарий,15) = "остатки для ERP" и деф.DeletionMark Тогда
		СсылкаВводОстатков = ЗагрузкаЗаказНаВнутреннееПотребление(id,деф, СтруктураОбъекта);
...
Функция ЗагрузкаЗаказНаВнутреннееПотребление(id, деф, СтруктураОбъекта, ВидОбъекта = "ЗаказНаВнутреннееПотребление")
	ИмяСобытияЖР = "Импорт_из_RabbitMQ_УПП";
