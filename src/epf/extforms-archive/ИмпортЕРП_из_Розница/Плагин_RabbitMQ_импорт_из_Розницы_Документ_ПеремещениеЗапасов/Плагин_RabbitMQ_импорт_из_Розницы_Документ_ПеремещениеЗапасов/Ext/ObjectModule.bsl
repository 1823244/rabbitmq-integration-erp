...
Функция ЗагрузитьОбъект(СтруктураОбъекта, jsonText = "") Экспорт
	...
	Если деф["КСП_НеНуженВЕРП"] = Истина Тогда
		ЗаписьЖурналаРегистрации(ИмяСобытияЖР,УровеньЖурналаРегистрации.Информация,,,
			"Документ ПеремещениеТоваров не загружен! Включен флаг КСП_НеНуженВЕРП! Объект: "+Строка(id.Ref));
		Возврат Неопределено;
	КонецЕсли;
	...
	Попытка			
		Если ОбъектДанных.Проведен Тогда
			...
			ЗаписьЖурналаРегистрации(ИмяСобытияЖР,УровеньЖурналаРегистрации.Информация,,,
				"Отмена проведения: <"+ПредставлениеОбъекта+">.");
		КонецЕсли;
	Исключение
		т=ПодробноеПредставлениеОшибки(ИнформацияОбОшибке());
		ЗаписьЖурналаРегистрации(ИмяСобытияЖР,УровеньЖурналаРегистрации.Ошибка,,,
			"Объект не загружен! Ошибка отмены проведения: <"+ПредставлениеОбъекта+">. Подробности: "+т);
		ОтменитьТранзакцию();
		ВызватьИсключение;
	КонецПопытки;	
	...
	Попытка			
		...
		СоздатьПеремещениеТоваров(ОбъектДанных.Ссылка);
