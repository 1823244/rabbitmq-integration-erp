...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ДобавитьКоманду(ПараметрыРегистрации.Команды, "Выполнить импорт из 1С:Розница","ЗагрузитьДанныеИз1СРозница",ТипКоманды, Ложь) ;
		...
		Пока Клиент.BasicConsumeMessage("", ПолучаемоеСообщение, ТегСообщения, 5000) Цикл
			...
			Исключение
				...
				КонецЕсли; 
					...
					ЗаписьЖурналаРегистрации(ИмяСобытияЖР,УровеньЖурналаРегистрации.Ошибка,,,
						"Сообщение к предыдущей ошибке:"+ПолучаемоеСообщение);
